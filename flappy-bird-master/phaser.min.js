...
!function (a, b) {
	...
	c.InteractionManager = function () {
		...
		var e = this.pivot.x, f = this.pivot.y, g = a[0], h = a[1], i = this.position.x - a[0] * e - f * a[1], j = a[3],
			k = a[4], l = this.position.y - a[4] * f - e * a[3], m = b[0], n = b[1], o = b[2], p = b[3], q = b[4],
			r = b[5];
		...
		if (a.value && a.value.baseTexture && a.value.baseTexture.hasLoaded) {
			if (c.gl.activeTexture(c.gl["TEXTURE" + this.textureCount]), c.gl.bindTexture(c.gl.TEXTURE_2D, a.value.baseTexture._glTexture), a.textureData) {
				var b = a.textureData, d = b.magFilter ? b.magFilter : c.gl.LINEAR,
					e = b.minFilter ? b.minFilter : c.gl.LINEAR, f = b.wrapS ? b.wrapS : c.gl.CLAMP_TO_EDGE,
					g = b.wrapT ? b.wrapT : c.gl.CLAMP_TO_EDGE, h = b.luminance ? c.gl.LUMINANCE : c.gl.RGBA;
		...
		var b, d, e, f, g, h, i, j, k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A = a.first, B = a.last._iNext,
		...
		if (b.fill) {
			var j = a(b.fillColor), k = b.fillAlpha, l = j[0] * k, m = j[1] * k, n = j[2] * k, o = d.points,
				p = d.indices, q = o.length / 6;
		...
		if (b.fill) {
			var l = a(b.fillColor), m = b.fillAlpha, n = l[0] * m, o = l[1] * m, p = l[2] * m, q = d.points,
				r = d.indices, s = q.length / 6;
			r.push(s);
		...
		if (0 !== e.length) {
			...
			var k, l, m, n, o, p, q, r, s, t, u, v, w, x, y, z, A, B, C, D, E, F = d.points, G = d.indices,
				H = e.length / 2, I = e.length, J = F.length / 6, K = b.lineWidth / 2, L = a(b.lineColor),
				M = b.lineAlpha, N = L[0] * M, O = L[1] * M, P = L[2] * M;
	...
	return c.WebGLRenderGroup.prototype.handleFilterBlock = function (a, b) {
		...
		var d = this.gl;
		c.shaderProgram;
		var e = a.tilePosition, f = a.tileScale, g = e.x / a.texture.baseTexture.width,
			h = e.y / a.texture.baseTexture.height, i = a.width / a.texture.baseTexture.width / f.x,
		...
		add: function (a) {
			...
			var c = a._iPrev, d = a._iNext, e = b._iPrev, f = b._iNext, g = this._container.last._iNext,
			...
			if (console.log(c), a) var e = this.game.stage._stage.last._iNext,
				f = this.game.stage._stage; else var e = this._container.last._iNext, f = this._container;
			do {
				var g = f.name || "*";
		...
		create: function (a, b) {
			...
			b = b || new d.Point;
			var c = a.getBoundingClientRect(), e = a.clientTop || document.body.clientTop || 0,
		...
		PI2: 2 * Math.PI, fuzzyEqual: function (a, b, c) {
		...
		bitmapFont: function (a, b, d) {
			...
			var e = c.TextureCache[d], f = {}, g = b.getElementsByTagName("info")[0],
			...
			for (var i = b.getElementsByTagName("char"), j = 0; j < i.length; j++) {
				var k = parseInt(i[j].attributes.getNamedItem("id").nodeValue, 10), l = {
		...
		getColor32: function (a, b, c, d) {
			...
			var c = parseInt(b.substring(0, 2), 16), d = parseInt(b.substring(2, 4), 16),
			...
			var g = d.Color.getRGB(a), h = d.Color.getRGB(b), i = (h.red - g.red) * e / c + g.red,
				j = (h.green - g.green) * e / c + g.green, k = (h.blue - g.blue) * e / c + g.blue;
			return d.Color.getColor32(f, i, j, k)
		}, interpolateColorWithRGB: function (a, b, c, e, f, g) {
			var h = d.Color.getRGB(a), i = (b - h.red) * g / f + h.red, j = (c - h.green) * g / f + h.green,
		...
		create: function (a, b, c) {
			...
			for (var f = b; b + d > f; f++) for (var g = a; a + c > g; g++) this._results.push({
				x: g,
				y: f,
